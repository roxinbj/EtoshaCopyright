...
class Onboarding2ViewController: OnboardingBaseViewController {
    ...
    private func setupFirstLabel(){
        ...
        NSLayoutConstraint.activate([
            ...
            spaceHolder.heightAnchor.constraint(equalTo: imageView.heightAnchor, multiplier: 0.001),
        ...
        let attributedString = NSMutableAttributedString(string:MyStrings.FirstBold1.locString, attributes: paragraphBoldAttributes)
        attributedString.append(NSMutableAttributedString(string:MyStrings.FirstNormal1.locString, attributes: paragraphNormalAttributes))
        attributedString.append(NSMutableAttributedString(string:MyStrings.FirstBold2.locString, attributes: paragraphBoldAttributes))
        attributedString.append(NSMutableAttributedString(string: MyStrings.FirstNormal2.locString, attributes: paragraphNormalAttributes))
    ...
    private func setupSecondLabel(){
        ...
        NSLayoutConstraint.activate([
            ...
            spaceHolder.heightAnchor.constraint(equalTo: imageView.heightAnchor, multiplier: 0.08),
            spaceHolder.leadingAnchor.constraint(equalTo: imageView.trailingAnchor),
            spaceHolder.trailingAnchor.constraint(equalTo: contentView.trailingAnchor)
        ])
    ...
    private func setupBottomCircle(){
        ...
        NSLayoutConstraint.activate([
            spaceHolder.topAnchor.constraint(equalTo: imageView.topAnchor),
            spaceHolder.heightAnchor.constraint(equalTo: imageView.heightAnchor, multiplier: 0.65),
            spaceHolder.leadingAnchor.constraint(equalTo: imageView.leadingAnchor),
...
extension Onboarding2ViewController{
    enum MyStrings :String {
        ...
        case FirstBold1 = "11Bold"
        case FirstNormal1 = "11Normal"
        case FirstBold2 = "12Bold"
        case FirstNormal2 = "12Normal"
        case SecondBold = "2Bold"
        case SecondNormal = "2Normal"
        case ThirdBold = "3Bold"
        case ThirdNormal = "3Normal"
        var locString : String {
            return NSLocalizedString("Onboarding2_" + self.rawValue, tableName: "Texts", bundle: .main, value: ErrorHandler.localizedStringNotFound, comment: "Loc String")
        }
    }
}
